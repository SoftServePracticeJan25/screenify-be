        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CinemaTypeId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rooms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Rooms_CinemaTypes_CinemaTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieActors", x => new { x.MovieId, x.ActorId, x.ActorRoleId });
                    table.ForeignKey(
                        name: "FK_MovieActors_ActorRoles_ActorRoleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieActors_ActorRoleId",
                table: "MovieActors",
                column: "ActorRoleId");
